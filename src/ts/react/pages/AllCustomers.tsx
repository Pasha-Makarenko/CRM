        ...
        <div className="main__container">
          <section className="customers">
            <div className="customers__heading">
              ...
              <ModalTarget idState={"customer-add"} className="customers__add-target button_violet">
                  ...
                  isLoading ?
                    ...
                    data && data.map((manager, j) => <React.Fragment key={j}>{
                      manager.clients.map((client, i) => <tr key={i} className="table-customers__row">
                          ...
                          <td className={`table-customers__item table-customers__item_stage table-customers__item_stage-${client.status.toLowerCase()}`}><span>
                            {client.status}
                          </span></td>
