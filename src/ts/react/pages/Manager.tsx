      ...
      <main className="main main_profile">
        <div className="main__container">
          <section className="profile">
            <h1 className="profile__title">Профиль менеджера</h1>
            <div className="profile__info">
              <div className="profile__image profile-image"></div>
              <div className="profile__text">
                <div className="profile__text-item profile__name">Имя фамилия</div>
                <div className="profile__text-item profile__role">Менеджер</div>
                <Link className="profile__text-item profile__link link" to={`/managers/${params["manager"]}/customers`}>Клиенты</Link>
                <Link className="profile__text-item profile__link link" to={`/managers/${params["manager"]}/deposits`}>Депозиты</Link>
              </div>
            </div>
